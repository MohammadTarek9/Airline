...
//        ArrayList<Booking> bookings = Passenger.getBookings();
   ...
   public void testSearchFlights() {
       ...
       ArrayList<Flight> result = Passenger.searchFlights("Cairo", "London");
       assertEquals(1, result.size());
       assertTrue(result.contains(flight2), "The flight from Cairo to London should be returned.");
...
public void testCreateAccountSuccess() {
    ...
    public void testCreateAccountEmailExists() {
        ...
        String email = "testuser@example.com";  // Assuming this email already exists in the database
        String password = "password123";
        String firstName = "Mohamed";
        String lastName = "seif";
        String phone = "+123456789012";
  ...
  @Test
    ...
    public void testLoginWithIncorrectPassword() {
        ...
        String result = Passenger.login("testuser@example.com", "wrongpassword");
        assertEquals("Incorrect password!", result);
    }
    @Test
    public void testLoginWithCorrectEmailAndPassword() {

        String result = Passenger.login("testuser@example.com", "password123");
        assertEquals("success", result);
    }
        ...
        public void testUpdateAccountWithValidData() {
            Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123", 30);
            String result = passenger.updateAccount("testuser@example.com", "brandnew@example.com", "newpassword123", "newpassword123", "+12345678901", "31");
            assertEquals("success", result);
        }
      @Test
      public void testUpdateAccountWithSameemail() {
        Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123", 30);
        String result = passenger.updateAccount("testuser@example.com", "testuser@example.com", "newpassword123", "newpassword123", "+12345678901", "31");
        ...
        public void testUpdateAccountWithInvalidEmailFormat() {
            Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123", 30);
            String result = passenger.updateAccount("testuser@example.com", "invalid-email", "newpassword123", "newpassword123", "+12345678901", "31");
            assertEquals("Invalid email format!", result);
        }
        ...
        public void testUpdateAccountWithEmailAlreadyExists() {
            ...
            String result = passenger.updateAccount("testuser@example.com", "old@example.com", "newpassword320", "newpassword320", "+12345678901", "45");
            assertEquals("Email already exists!", result);
        }
        ...
        public void testUpdateAccountWithShortPassword() {
            Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123", 30);
            String result = passenger.updateAccount("testuser@example.com", "newemail@example.com", "new", "new", "+12345678901", "31");
            assertEquals("Password must be at least 6 characters long!", result);
        }
        ...
        public void testUpdateAccountWithPasswordMismatch() {
            Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123", 30);
            String result = passenger.updateAccount("testuser@example.com", "newemail@example.com", "newpassword123", "differentpassword", "+12345678901", "31");
        ...
        public void testUpdateAccountWithInvalidPhoneFormat() {
            Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123", 30);
            String result = passenger.updateAccount("testuser@example.com", "newemail@example.com", "newpassword123", "newpassword123", "12345", "31");
            assertEquals("Invalid phone number format!", result);
        }
        ...
        public void testUpdateAccountWithInvalidAgeFormat() {
            Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123",30);
            String result = passenger.updateAccount("testuser@example.com", "newemail@example.com", "newpassword123", "newpassword123", "+12345678901", "invalid age");
            assertEquals("Age must be a number!", result);
        }
        ...
        public void testUpdateAccountWithNoChanges() {
            Passenger passenger = new Passenger("Mohamed", "Seif", "+1234567890", "testuser@example.com", "password123", 30);
            String result = passenger.updateAccount("testuser@example.com", "testuser@example.com", "password123", "password123", "+1234567890","30");
